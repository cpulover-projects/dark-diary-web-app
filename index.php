...
<div class="container">
        ...
        <div class="display-4 mb-3"><i> Secure your darkest <b>secrets</b></i> </div>
        ...
        <div id="signUpForm">
                <form action="" method="post">
                        ...
                        <div class="form-group">
                                <input type="password" name="password" id="password1" placeholder="Enter password" class="form-control">
                        </div>
                        <div class="form-group">
        ...
        <div id="signInForm">
                <form action="" method="post">
                        ...
                        <div class="form-group">
                                <input type="password" name="password" id="password2" placeholder="Enter password" class="form-control">
                        </div>
                        <div class="form-group">
